...
class channelAPI {
   ...
   function getChannels($latParam,$lonParam,$distance) {
...
if ($ort == "6") {
	...
	$output = (" <img src=\"https://s3-us-west-1.amazonaws.com/snappcastphotos/images/" . $row['filename'] . "\" alt=\"Forest\" width=\"600\" height=\"400\" class=\"rotateimg90\" > ");
...
$api = new channelAPI;
$api->getChannels($lat,$lon,$distance);
