...
$exif = exif_read_data('https://s3-us-west-1.amazonaws.com/snappcastphotos/images/' . $row['filename'], 0, true);
$ort = $exif['IFD0']['Orientation'];
echo "*******Orientation";
echo $ort;

if ($ort = "6") {
	echo "Rotate 90degrees right";
} else {
        echo "Image ok as is";
}
...
// testing EXIF Data
//$exif = exif_read_data('https://s3-us-west-1.amazonaws.com/snappcastphotos/images/1342CEC2-92B1-42AF-8156-2486587D7ED9-14981-000012167ED688D9', 0, true);
...
//$source = imagecreatefromjpeg('https://s3-us-west-1.amazonaws.com/snappcastphotos/images/' . $row['filename']);
