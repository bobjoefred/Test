...
//setup table
echo "<table id=\"t01\", style = \"border: 1px solid black;color: white\" >";


$result = mysqli_query($con,
"SELECT channelid, title, description,locationname, lat,lon,private_fl, searchradius, channelid
FROM channels
WHERE ownerid = $ownerid");
 ...
 while($row = mysqli_fetch_array($result)) {
	       ...
	       echo "<tr>";
               ...
               echo $row['title'];
               //echo "<a href=\"javascript:hello()\">$row['title']<//a>";
               echo "<//td>";
               echo "<td style = \"border: 1px solid black\" >";
